...
- Fuentes editables PlantUML en `docs/semana-01/uml/`.
- Imagenes exportadas en `docs/semana-01/imagenes/`.
- Matriz de trazabilidad en `docs/semana-01/matriz-trazabilidad.md`.
