...
| RT-13 | Si falla la consulta de alergias, el proceso debe abortarse con error. | Excepcion documentada en `docs/semana-01/uml/README.md` | Rama `Se pudieron consultar las alergias?` con salida `No` | Alternativa `Error al consultar alergias`, respuesta `503` |
| RT-14 | Si falla el guardado, el sistema debe informar error y no confirmar exito. | Excepcion documentada en `docs/semana-01/uml/README.md` | Decision `Guardado exitoso?` con salida `No` | Alternativa `Error al guardar`, respuesta `500` |
