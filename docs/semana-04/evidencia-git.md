...
- El working tree se mantuvo limpio durante el desarrollo (solo adiciones de documentación en `docs/semana-04/`).
...
| Archivo | Estado |
|---|---|
| `docs/semana-04/README.md` | nuevo |
| `docs/semana-04/responsabilidades.md` | nuevo |
| `docs/semana-04/objetos-reutilizables.md` | nuevo |
| `docs/semana-04/repositorio-datos-compartido.md` | nuevo |
| `docs/semana-04/evidencia-git.md` | este archivo |
| `docs/semana-04/diagramas/arquitectura-capas.puml` | nuevo |
| `docs/semana-04/diagramas/arquitectura-capas.png` | generado |
| `docs/semana-04/diagramas/repositorio-datos-compartido.puml` | nuevo |
| `docs/semana-04/diagramas/repositorio-datos-compartido.png` | generado |
...
- `arquitectura-capas.png` y `repositorio-datos-compartido.png` generados con PlantUML (v1.2024.8) a partir de los `.puml` de `docs/semana-04/diagramas/`.
