...
- `docs/semana-04/responsabilidades.md`
- `docs/semana-04/objetos-reutilizables.md`
- `docs/semana-04/repositorio-datos-compartido.md`
- `docs/semana-04/evidencia-git.md`
- `docs/semana-04/diagramas/arquitectura-capas.puml` (+ PNG)
- `docs/semana-04/diagramas/repositorio-datos-compartido.puml` (+ PNG)
