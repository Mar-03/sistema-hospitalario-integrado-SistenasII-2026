...
- `docs/semana-03/README.md` (este archivo).
- `docs/semana-03/evidencia-git.md`.
- `docs/semana-03/diagramas/arquitectura-c4.puml` (fuente PlantUML editable).
- `docs/semana-03/diagramas/arquitectura-c4.png` (render).
