...
| Archivo | Estado |
|---|---|
| `docs/semana-05/README.md` | nuevo |
| `docs/semana-05/contrato-api.md` | nuevo |
| `docs/semana-05/integracion-his.md` | nuevo |
| `docs/semana-05/evidencia-validacion.md` | nuevo |
| `docs/semana-05/evidencia-git.md` | este archivo |
| `docs/semana-05/diagramas/integracion-cliente-servidor.puml` | nuevo |
| `docs/semana-05/diagramas/integracion-cliente-servidor.png` | generado |
...
- `integracion-cliente-servidor.png` generado con PlantUML a partir del `.puml` de `docs/semana-05/diagramas/`, sin errores de renderizado.
