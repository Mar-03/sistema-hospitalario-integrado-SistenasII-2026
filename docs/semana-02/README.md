...
|---|---|---|
| RF/RNF y criterios | `docs/semana-02/README.md` | Requisitos y criterios verificables |
| Diseno antes/despues editable | `docs/semana-02/diseno-antes-despues.puml` | Diagrama modificable en PlantUML |
| Infraestructura de red y servidor | `docs/semana-02/infraestructura-red-servidor.md` | Propuesta tecnica para despliegue |
| Infraestructura de red y servidor editable | `docs/semana-02/infraestructura-red-servidor.puml` | Diagrama de despliegue modificable |
| Guia de defensa | `docs/semana-02/guia-defensa.md` | Preguntas y respuestas para defensa oral |
| Evidencia de validacion | `docs/semana-02/evidencia-validacion.md` | Checklist y comandos sugeridos |
| Evidencia Git | `docs/semana-02/evidencia-git.md` | Historial, remoto, rama, estado y commits verificados |
