...
La integración con el repositorio de datos compartido del HIS fue analizada en `ascii15/semana-04/repositorio-datos-compartido.md`. En el futuro, ASII-15 **consumiría**:
