...
Detalle completo: `ascii15/semana-05/contrato-api.md`.
...
- **Integración futura (diseño)**: consumir pacientes, medicamentos, alergias e identidad/autorización de médicos desde el HIS compartido (análisis de owners y puertos en `ascii15/semana-04/repositorio-datos-compartido.md`).

Detalle completo: `ascii15/semana-05/integracion-his.md`.
...
- Números y comandos reproducibles: `ascii15/semana-05/evidencia-validacion.md`.
- Evidencia Git: `ascii15/semana-05/evidencia-git.md`.

## 10. Archivos entregados

- `ascii15/semana-05/README.md`
- `ascii15/semana-05/contrato-api.md`
- `ascii15/semana-05/integracion-his.md`
- `ascii15/semana-05/evidencia-validacion.md`
- `ascii15/semana-05/evidencia-git.md`
- `ascii15/semana-05/diagramas/integracion-cliente-servidor.puml` (+ PNG)
