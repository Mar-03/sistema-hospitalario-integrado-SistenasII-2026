...
Ver `ascii15/semana-04/diagramas/repositorio-datos-compartido.puml` (+ PNG): HIS compartido → Repository Ports → Application ASII-15 → Domain → Prescripciones (owner ASII-15) → Auditoría, con relaciones etiquetadas LEE / ESCRIBE / OWNER.