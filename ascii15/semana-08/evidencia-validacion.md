...
- `ascii15/semana-08/wireframes/prescripcion-principal.puml`.
- `ascii15/semana-08/wireframes/alergia-excepcion.puml`.

PNG generados:

- `ascii15/semana-08/wireframes/prescripcion-principal.png` (`820x432`, `16327` bytes).
- `ascii15/semana-08/wireframes/alergia-excepcion.png` (`804x358`, `14391` bytes).
