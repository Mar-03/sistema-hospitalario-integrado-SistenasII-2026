...
La verificacion inicial se hizo desde el worktree principal antes de crear S6. Se confirmo que `origin/developer` contiene el merge de Semana 5 y que los archivos `ascii15/semana-05/` estan presentes en el arbol remoto.
...
| Archivo | Estado |
|---|---|
| `ascii15/semana-06/README.md` | nuevo |
| `ascii15/semana-06/evidencia-parcial.md` | nuevo |
| `ascii15/semana-06/evidencia-git.md` | este archivo |
