...
- `ascii15/semana-10/wireframes/prescripcion-desktop.puml`.
- `ascii15/semana-10/wireframes/prescripcion-mobile.puml`.
- `ascii15/semana-10/wireframes/alerta-mobile.puml`.

PNG generados:

- `ascii15/semana-10/wireframes/prescripcion-desktop.png` (`716x439`, `16743` bytes).
- `ascii15/semana-10/wireframes/prescripcion-mobile.png` (`420x677`, `15579` bytes).
- `ascii15/semana-10/wireframes/alerta-mobile.png` (`360x466`, `12792` bytes).
